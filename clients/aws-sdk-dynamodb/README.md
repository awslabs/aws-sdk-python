...
The `aws_sdk_dynamodb` client is still under active development.
...
follow the instructions in the docs [README.md](https://github.com/aws/aws-sdk-python/blob/main/clients/aws-sdk-dynamodb/docs/README.md).
