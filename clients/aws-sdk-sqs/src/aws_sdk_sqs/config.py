...
from ._private.schemas import AMAZON_SQS as _SCHEMA_AMAZON_SQS
...
_ServiceInterceptor = Union[
    ...
    Interceptor[CancelMessageMoveTaskInput, CancelMessageMoveTaskOutput, Any, Any],
    Interceptor[ChangeMessageVisibilityInput, ChangeMessageVisibilityOutput, Any, Any],
    Interceptor[
        ChangeMessageVisibilityBatchInput, ChangeMessageVisibilityBatchOutput, Any, Any
    ],
    Interceptor[CreateQueueInput, CreateQueueOutput, Any, Any],
    Interceptor[DeleteMessageInput, DeleteMessageOutput, Any, Any],
    Interceptor[DeleteMessageBatchInput, DeleteMessageBatchOutput, Any, Any],
    Interceptor[DeleteQueueInput, DeleteQueueOutput, Any, Any],
    Interceptor[GetQueueAttributesInput, GetQueueAttributesOutput, Any, Any],
    Interceptor[GetQueueUrlInput, GetQueueUrlOutput, Any, Any],
    Interceptor[
        ListDeadLetterSourceQueuesInput, ListDeadLetterSourceQueuesOutput, Any, Any
    ],
    Interceptor[ListMessageMoveTasksInput, ListMessageMoveTasksOutput, Any, Any],
    Interceptor[ListQueuesInput, ListQueuesOutput, Any, Any],
    Interceptor[ListQueueTagsInput, ListQueueTagsOutput, Any, Any],
    Interceptor[PurgeQueueInput, PurgeQueueOutput, Any, Any],
    Interceptor[ReceiveMessageInput, ReceiveMessageOutput, Any, Any],
    Interceptor[RemovePermissionInput, RemovePermissionOutput, Any, Any],
    Interceptor[SendMessageInput, SendMessageOutput, Any, Any],
    Interceptor[SendMessageBatchInput, SendMessageBatchOutput, Any, Any],
    Interceptor[SetQueueAttributesInput, SetQueueAttributesOutput, Any, Any],
    Interceptor[StartMessageMoveTaskInput, StartMessageMoveTaskOutput, Any, Any],
    Interceptor[TagQueueInput, TagQueueOutput, Any, Any],
    Interceptor[UntagQueueInput, UntagQueueOutput, Any, Any],
]


class _AsyncSQSConfigOverrides(AwsConfigOverrides, total=False):
...
class AsyncSQSConfig(AsyncAwsConfig):
    ...
    _FIELDS: ClassVar[dict[str, FieldSpec]] = {
        ...
        **AsyncAwsConfig._FIELDS,
        "endpoint_uri": FieldSpec(default=None, resolver=EndpointUriResolver("sqs")),
        ...
        "protocol": FieldSpec(
            default_factory=lambda: AwsJson10ClientProtocol(_SCHEMA_AMAZON_SQS)
        ),
        "auth_schemes": FieldSpec(
            default_factory=lambda: {
                ShapeID("aws.auth#sigv4"): SigV4AuthScheme(service="sqs")
            }
        ),
    ...
    async def resolve(  # pyright: ignore[reportIncompatibleMethodOverride]
        ...
        **overrides: Unpack[_AsyncSQSConfigOverrides],
    ) -> Self:
        """
