...
class _AsyncLexRuntimeV2ConfigOverrides(AwsConfigOverrides, total=False):
...
class AsyncLexRuntimeV2Config(AsyncAwsConfig):
    """Lex Runtime V2 configuration (async-resolved)."""
    ...
    _FIELDS: ClassVar[dict[str, FieldSpec]] = {
        ...
        **AsyncAwsConfig._FIELDS,
        "endpoint_uri": FieldSpec(
            default=None, resolver=EndpointUriResolver("lex_runtime_v2")
        ),
    ...
    async def resolve(  # pyright: ignore[reportIncompatibleMethodOverride]
        ...
        **overrides: Unpack[_AsyncLexRuntimeV2ConfigOverrides],
    ) -> Self:
        """
...
Plugin: TypeAlias = Callable[[AsyncLexRuntimeV2Config], None]
"""
