...
class _AsyncLambdaConfigOverrides(AwsConfigOverrides, total=False):
...
class AsyncLambdaConfig(AsyncAwsConfig):
    """Lambda configuration (async-resolved)."""
    ...
    _FIELDS: ClassVar[dict[str, FieldSpec]] = {
        ...
        **AsyncAwsConfig._FIELDS,
        "endpoint_uri": FieldSpec(default=None, resolver=EndpointUriResolver("lambda")),
        ...
        "protocol": FieldSpec(
            default_factory=lambda: RestJsonClientProtocol(_SCHEMA_AWS_GIR_API_SERVICE)
        ),
    ...
    async def resolve(  # pyright: ignore[reportIncompatibleMethodOverride]
        ...
        **overrides: Unpack[_AsyncLambdaConfigOverrides],
    ) -> Self:
        """
...
Plugin: TypeAlias = Callable[[AsyncLambdaConfig], None]
"""
