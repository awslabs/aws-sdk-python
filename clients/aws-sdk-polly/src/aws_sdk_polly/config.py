...
class _AsyncPollyConfigOverrides(AwsConfigOverrides, total=False):
...
class AsyncPollyConfig(AsyncAwsConfig):
    """Polly configuration (async-resolved)."""
    ...
    _FIELDS: ClassVar[dict[str, FieldSpec]] = {
        ...
        **AsyncAwsConfig._FIELDS,
        "endpoint_uri": FieldSpec(default=None, resolver=EndpointUriResolver("polly")),
        ...
        "protocol": FieldSpec(
            default_factory=lambda: RestJsonClientProtocol(_SCHEMA_PARROT_V1)
        ),
    ...
    async def resolve(  # pyright: ignore[reportIncompatibleMethodOverride]
        ...
        **overrides: Unpack[_AsyncPollyConfigOverrides],
    ) -> Self:
        """
...
Plugin: TypeAlias = Callable[[AsyncPollyConfig], None]
"""
