...
class _AsyncSageMakerRuntimeHTTP2ConfigOverrides(AwsConfigOverrides, total=False):
...
class AsyncSageMakerRuntimeHTTP2Config(AsyncAwsConfig):
    """SageMaker Runtime HTTP2 configuration (async-resolved)."""
    ...
    _FIELDS: ClassVar[dict[str, FieldSpec]] = {
        ...
        **AsyncAwsConfig._FIELDS,
        "endpoint_uri": FieldSpec(
            default=None, resolver=EndpointUriResolver("sagemaker_runtime_http2")
        ),
    ...
    async def resolve(  # pyright: ignore[reportIncompatibleMethodOverride]
        ...
        **overrides: Unpack[_AsyncSageMakerRuntimeHTTP2ConfigOverrides],
    ) -> Self:
        """
...
Plugin: TypeAlias = Callable[[AsyncSageMakerRuntimeHTTP2Config], None]
"""
