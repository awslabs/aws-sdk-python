...
class _AsyncConnectHealthConfigOverrides(AwsConfigOverrides, total=False):
...
class AsyncConnectHealthConfig(AsyncAwsConfig):
    """ConnectHealth configuration (async-resolved)."""
    ...
    _FIELDS: ClassVar[dict[str, FieldSpec]] = {
        ...
        **AsyncAwsConfig._FIELDS,
        "endpoint_uri": FieldSpec(
            default=None, resolver=EndpointUriResolver("connecthealth")
        ),
        ...
        "protocol": FieldSpec(
            default_factory=lambda: RestJsonClientProtocol(_SCHEMA_CONNECT_HEALTH)
        ),
    ...
    async def resolve(  # pyright: ignore[reportIncompatibleMethodOverride]
        ...
        **overrides: Unpack[_AsyncConnectHealthConfigOverrides],
    ) -> Self:
        """
...
Plugin: TypeAlias = Callable[[AsyncConnectHealthConfig], None]
"""
