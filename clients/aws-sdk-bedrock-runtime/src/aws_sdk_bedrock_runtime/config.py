...
class _AsyncBedrockRuntimeConfigOverrides(AwsConfigOverrides, total=False):
...
class AsyncBedrockRuntimeConfig(AsyncAwsConfig):
    """Bedrock Runtime configuration (async-resolved)."""
    ...
    async def resolve(  # pyright: ignore[reportIncompatibleMethodOverride]
        ...
        **overrides: Unpack[_AsyncBedrockRuntimeConfigOverrides],
    ) -> Self:
        """
