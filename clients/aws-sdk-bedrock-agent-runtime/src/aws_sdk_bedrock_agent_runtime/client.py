...
from .config import AsyncBedrockAgentRuntimeConfig, Plugin
from .models import (
...
class AsyncBedrockAgentRuntimeClient:
    ...
    def __init__(
        self,
        config: AsyncBedrockAgentRuntimeConfig | None = None,
            ...
            async with self._derive_lock:
                if not self._setup_done:
                    if self._config is None:
                        config = await AsyncBedrockAgentRuntimeConfig.resolve()
                    else:
