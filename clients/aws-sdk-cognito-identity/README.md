...
The `aws_sdk_cognito_identity` client is still under active development.
...
follow the instructions in the docs [README.md](https://github.com/aws/aws-sdk-python/blob/main/clients/aws-sdk-cognito-identity/docs/README.md).
