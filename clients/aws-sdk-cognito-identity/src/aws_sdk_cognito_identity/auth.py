...
class HTTPAuthSchemeResolver:
    def resolve_auth_scheme(
        ...
        if auth_parameters.operation == "GetCredentialsForIdentity":
            return auth_options

        if auth_parameters.operation == "GetId":
            return auth_options

        if auth_parameters.operation == "GetOpenIdToken":
            return auth_options

        if auth_parameters.operation == "UnlinkIdentity":
            return auth_options
