...
The `aws_sdk_secrets_manager` client is still under active development.
...
follow the instructions in the docs [README.md](https://github.com/aws/aws-sdk-python/blob/main/clients/aws-sdk-secrets-manager/docs/README.md).
