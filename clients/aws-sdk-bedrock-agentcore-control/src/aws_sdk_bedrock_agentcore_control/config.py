...
class AsyncBedrockAgentCoreControlConfig(AsyncAwsConfig):
    """Bedrock AgentCore Control configuration (async-resolved)."""
    ...
    _FIELDS: ClassVar[dict[str, FieldSpec]] = {
        ...
        **AsyncAwsConfig._FIELDS,
        "endpoint_uri": FieldSpec(
            default=None, resolver=EndpointUriResolver("bedrock_agentcore_control")
        ),
    ...
    async def resolve(  # pyright: ignore[reportIncompatibleMethodOverride]
        ...
        **overrides: Unpack[_AsyncBedrockAgentCoreControlConfigOverrides],
    ) -> Self:
        """
...
Plugin: TypeAlias = Callable[[AsyncBedrockAgentCoreControlConfig], None]
"""
