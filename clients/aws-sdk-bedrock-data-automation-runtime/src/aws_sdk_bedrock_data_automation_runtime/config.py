...
from ._private.schemas import (
    AMAZON_BEDROCK_KEYSTONE_RUNTIME_SERVICE as _SCHEMA_AMAZON_BEDROCK_KEYSTONE_RUNTIME_SERVICE,
)
...
_ServiceInterceptor = Union[
    Interceptor[GetDataAutomationStatusInput, GetDataAutomationStatusOutput, Any, Any],
    Interceptor[InvokeDataAutomationInput, InvokeDataAutomationOutput, Any, Any],
    Interceptor[
        InvokeDataAutomationAsyncInput, InvokeDataAutomationAsyncOutput, Any, Any
    ],
...
class _AsyncBedrockDataAutomationRuntimeConfigOverrides(
    AwsConfigOverrides, total=False
):
...
class AsyncBedrockDataAutomationRuntimeConfig(AsyncAwsConfig):
    """Bedrock Data Automation Runtime configuration (async-resolved)."""
    ...
    _FIELDS: ClassVar[dict[str, FieldSpec]] = {
        ...
        **AsyncAwsConfig._FIELDS,
        "endpoint_uri": FieldSpec(
            default=None,
            resolver=EndpointUriResolver("bedrock_data_automation_runtime"),
        ),
        ...
        "protocol": FieldSpec(
            default_factory=lambda: AwsJson11ClientProtocol(
                _SCHEMA_AMAZON_BEDROCK_KEYSTONE_RUNTIME_SERVICE
            )
        ),
    ...
    async def resolve(  # pyright: ignore[reportIncompatibleMethodOverride]
        ...
        **overrides: Unpack[_AsyncBedrockDataAutomationRuntimeConfigOverrides],
    ) -> Self:
        """
...
Plugin: TypeAlias = Callable[[AsyncBedrockDataAutomationRuntimeConfig], None]
"""
