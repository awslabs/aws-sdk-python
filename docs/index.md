...
Experimental async clients for AWS services, distributed as one lightweight
package per service.
...
!!! warning "Experimental"
    ...
    This project is in early development and under rapid iteration. Until
    version 1.0.0, breaking changes to public interfaces and general behaviors
    may occur between minor versions. We strongly advise pinning to an exact
    version of each client package for any non-experimental use.
...
- **Fully typed**: Generated dataclass models and annotated signatures for
  every operation.
- **Streaming support**: First-class support for [event streams](streaming.md)
  and bidirectional streaming operations.
...
guidance, and [Available Clients](clients/index.md) for the full list of
service packages.
...
- :material-rocket-launch-outline:{ .lg .middle } **Quickstart**
    ...
    Install a client, configure credentials, and make your first request.

    [:octicons-arrow-right-24: Quickstart](quickstart.md)

- :material-package-variant-closed:{ .lg .middle } **Available Clients**
...
- :material-message-alert-outline:{ .lg .middle } **Feedback**
    ...
    [:octicons-arrow-right-24: Open a GitHub issue](https://github.com/awslabs/aws-sdk-python/issues/new/choose)
